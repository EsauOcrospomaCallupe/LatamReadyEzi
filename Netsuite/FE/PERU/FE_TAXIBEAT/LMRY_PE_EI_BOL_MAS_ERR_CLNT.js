...
var nameScript = "LMRY_PE_EI_BOL_MAS_ERR_CLNT"

function lmryEIBolErrInitPageCLNT(){
	/*
...
function lmryEIBolErrSaveRecordCLNT(){
	...
	if (param_date_from != null && param_date_from != '' && param_date_to != null && param_date_to != '' && param_serie != null && param_serie != '') {
		...
		busquedaTransacciones.addFilter(new nlobjSearchFilter('custrecord_lmry_pe_ei_status', null, 'is', 'ERR_TIM_OUT_COMFIAR'));
