 ...
 */
    ...
    function lmry_ei_bol_mas_rech(type)
    {
        try{
            ...
            var param_date_from   = objContext.getSetting('SCRIPT', 'custscript_lmry_pe_err_date_from');
            var param_date_to     = objContext.getSetting('SCRIPT', 'custscript_lmry_pe_err_date_to');
            var param_serie       = objContext.getSetting('SCRIPT', 'custscript_lmry_pe_err_series');
            var subsidiary   = null;
            var subsi_numdoc = "";
            if (featuresubs == true || featuresubs == 'T'){
                param_subsidiary = objContext.getSetting('SCRIPT', 'custscript_lmry_pe_err_subsi');
            ...
            */
            ...
            busqBolMas.addFilter(new nlobjSearchFilter('custrecord_lmry_pe_ei_status', null, 'is', 'ERR_TIM_OUT_COMFIAR'));
