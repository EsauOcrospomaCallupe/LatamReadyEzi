...
<TextosLibres>
	...
	<TextoLibre2>${transaction. duedate}</TextoLibre2>
<TextoLibre3>${transaction.terms}</TextoLibre3>
<TextoLibre4></TextoLibre4>
<TextoLibre5></TextoLibre5>
<TextoLibre6></TextoLibre6>
<TextoLibre7>${customer.entityid}</TextoLibre7>
<TextoLibre8>${transaction.custbody_lmry_doc_ref_date}</TextoLibre8>
<TextoLibre9></TextoLibre9>
<TextoLibre10>${transaction.currency}</TextoLibre10>
<TextoLibre11>${transaction.tranid}</TextoLibre11>
